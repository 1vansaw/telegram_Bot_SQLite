...
class Settings():
    ...
    MAX_FILE_AGE = 86400                        # время жизни файлов в папке temp_files
    PER_PAGE = 10                               # количество схем на странице
    DOWNLOAD_TIMEOUT = 600                      # время таймаута при скачивании с яндекса
    ...
    MAX_FILE_SIZE_MB = 45                       # максимальный размер файла для загрузки в руководства
    ...
    ITEMS_PER_PAGE = 10                         # количество станков на странице
